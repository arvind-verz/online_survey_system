            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs pull-right">
                        <li class="active">
                            <a data-toggle="tab" href="#revenue-chart">
                                Area
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#sales-chart">
                                Donut
                            </a>
                        </li>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-footer clearfix">
                        <button class="pull-right btn btn-default" id="sendEmail" type="button">
                            Send
                            <i class="fa fa-arrow-circle-right">
                            </i>
                        </button>
            ...
            <section class="col-lg-5 connectedSortable">
                ...
                <div class="box box-solid bg-light-blue-gradient">
                    <div class="box-header">
                        <!-- tools box -->
                        <div class="pull-right box-tools">
                            <button class="btn btn-primary btn-sm daterange pull-right" data-toggle="tooltip" title="Date range" type="button">
                                <i class="fa fa-calendar">
                                </i>
                            </button>
                            <button class="btn btn-primary btn-sm pull-right" data-toggle="tooltip" data-widget="collapse" style="margin-right: 5px;" title="Collapse" type="button">
                                <i class="fa fa-minus">
                                </i>
                            </button>
                        </div>
                ...
                <div class="box box-solid bg-teal-gradient">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <button class="btn bg-teal btn-sm" data-widget="collapse" type="button">
                                <i class="fa fa-minus">
                                </i>
                            </button>
                            <button class="btn bg-teal btn-sm" data-widget="remove" type="button">
                                <i class="fa fa-times">
                                </i>
                            </button>
                        </div>
